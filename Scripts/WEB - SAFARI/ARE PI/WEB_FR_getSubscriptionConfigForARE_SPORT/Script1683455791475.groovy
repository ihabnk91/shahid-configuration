...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "FR", "SHAHID_VIP_SPORT","AE" , "true")
...
// Monthly applePay
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[0].pricingPlanData[1].productId', "UAE_B2C_SHAHID_VIP_SPORT_1M")
...
// Yearly applePay
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[2].pricingPlanData[1].productId', "UAE_B2C_SHAHID_VIP_SPORT_12M")
