...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "FR", "SHAHID_VIP","SA" , "true")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 39.99  par mois (TTC)")
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[19].key','summary_text_2')
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[19].value',"Ce service sera renouvelé automatiquement.")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[1].value[0]',"<ul> <li> Ce service sera renouvelé automatiquement. </li> <li> Frais mensuels de SAR 34,99 (TVA incluse). </li> <li> Pour toute question, contactez-nous à l'adresse suivante : care@shahid.net </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].groups[0].pricingPlans[0].visualElements[13].value','Mensuel')
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 39.99  par mois (TTC)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].specialOfferLandingPage.visualElements[1].value[0]',"<ul> <li> Ce service sera renouvelé automatiquement. </li> <li> Frais mensuels de SAR 34,99 (TVA incluse). </li> <li> Pour toute question, contactez-nous à l'adresse suivante : care@shahid.net </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].groups[0].pricingPlans[0].visualElements[13].value','Mensuel')
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 39.99  par mois (TTC)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[0].value[0]',"CGU")
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[1].key','pop_up_tab_content')
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[1].value[0]',"<ul> <li> Ce service sera renouvelé automatiquement. </li> <li> Frais mensuels de SAR 34,99 (TVA incluse). </li> <li> Pour toute question, contactez-nous à l'adresse suivante : care@shahid.net </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[6].value',"Essayez l'offre VIP Shahid")
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[7].key','guideline_cta')
WS.verifyElementPropertyValue(getResponse, 'deals[2].specialOfferLandingPage.visualElements[7].value[0]',"Les CGU s'appliquent.")
