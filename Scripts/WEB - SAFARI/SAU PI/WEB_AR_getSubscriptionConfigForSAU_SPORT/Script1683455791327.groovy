...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "AR", "SHAHID_VIP_SPORT","SA" , "true")
...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[2].visualElements[4].value', '699.99 SAR تدفع سنويا' )
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[18].value',"عالم الترفيه بين يديك.\n اشترك الآن. رسوم شهرية 69.99 ريال سعودي (شاملة لضريبة القيمة المضافة)")
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[19].key','summary_text_2')
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[19].value',"سيتم تجديد الاشتراك تلقائياً")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[1].value[0]','<ul> <li> يتم تجديد الاشتراك تلقائياً. </li> <li>رسوم شهرية 69.99 ريال سعودي (شاملة لضريبة القيمة المضافة)  </li> <li>للاستفسارات الرجاء التواصل مع  care@shahid.net </li> </ul>')
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[6].value',"اشترك الآن!")
