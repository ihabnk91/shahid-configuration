...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[0].pricingPlanData[4].productId', "KSA_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[0].pricingPlanData[4].priceLabel', "39.99")
...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[2].visualElements[4].value', ' 339.99 SAR  تدفع سنوياً')
...
// Yearly Credit Card
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[2].pricingPlanData[1].productId', "KSA_B2C_SHAHID_VIP_12M")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[18].value','شاهد VIP - وجهتك الأمثل للترفيه اشترك الآن !! الرسوم الشهرية 39.99 ريال سعودي (شاملاً ضريبة القيمة المضافة)')
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].groups[0].pricingPlans[0].visualElements[18].value','شاهد VIP - وجهتك الأمثل للترفيه اشترك الآن !! الرسوم الشهرية 39.99 ريال سعودي (شاملاً ضريبة القيمة المضافة)' )
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].specialOfferLandingPage.visualElements[1].value[0]','<ul> <li> سيتم تجديد الخدمة تلقائيًا. </li> <li> الرسوم الشهرية ٣٤.٩٩ ريال سعودي (شاملاً ضريبة القيمة المضافة) </li> <li> للاستفسارات تواصل معنا على care@shahid.net. </li> </ul>' )
