...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "EN", "SHAHID_VIP","KW" , "true")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[1].value[0]', '<ul> <li> Subscription will be automatically renewed </li> <li> Monthly charges KWD 2.89 (VAT Inclusive) </li> <li> For inquiries, contact us at care@shahid.net. </li> </ul>' )
