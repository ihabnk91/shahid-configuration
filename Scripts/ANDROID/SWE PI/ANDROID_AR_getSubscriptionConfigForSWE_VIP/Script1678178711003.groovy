...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("ANDROID_APP", "AR", "SHAHID_VIP","SE" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[2].value', '81 SEK / شهرياً')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[2].value', '69 SEK / شهرياً')
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[2].value', '58 SEK / شهرياً')
...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[0].price', '115.0')
...
WS.verifyElementPropertyValue(getResponse, 'groups[0].pricingPlans[1].price', '979.0')
