...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "EN", "SHAHID_VIP","AU" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].price', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[8].value', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_30P_AUS')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].price', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[8].value', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_40P_AUS')
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].price', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[8].value', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_50P_AUS')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].price', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[8].value', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '11.9')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_30P_AUS')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].price', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[8].value', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '9.89')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_40P_AUS')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].price', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].currency', 'AUD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[8].value', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[9].value', 'AUD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].productId', "AUS_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '8.29')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'AUD')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_50P_AUS')
