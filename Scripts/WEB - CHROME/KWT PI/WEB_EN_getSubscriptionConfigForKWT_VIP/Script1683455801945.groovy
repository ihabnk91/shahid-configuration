...
WS.verifyElementPropertyValue(getResponse, 'offers[3].groups[0].pricingPlans[0].visualElements[2].value', '0.89 KWD/ month')
...
WS.verifyElementPropertyValue(getResponse, 'offers[4].groups[0].pricingPlans[0].visualElements[2].value', '0.89 KWD/ month')
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[18].value', "Shahid VIP - All the greatest entertainment in one place. Subscribe now for KWD 3.29 per month (VAT Inclusive)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[1].value[0]', "<ul> <li> Subscription will be automatically renewed </li> <li> Monthly charges KWD 3.29 (VAT Inclusive) </li> <li> For inquiries, contact us at care@shahid.net. </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].groups[0].pricingPlans[0].visualElements[18].value', "Shahid VIP - All the greatest entertainment in one place. Subscribe now for KWD 3.29 per month (VAT Inclusive)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].specialOfferLandingPage.visualElements[1].value[0]', "<ul> <li> Subscription will be automatically renewed </li> <li> Monthly charges KWD 3.29 (VAT Inclusive) </li> <li> For inquiries, contact us at care@shahid.net. </li> </ul>")
