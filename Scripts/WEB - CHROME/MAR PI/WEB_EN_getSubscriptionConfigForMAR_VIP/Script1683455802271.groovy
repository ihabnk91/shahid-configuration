...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "EN", "SHAHID_VIP","MA" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[13].value',"A world of entertainment at your fingertips \n Join now. Monthly charges DH 19 (VAT Inclusive)")
