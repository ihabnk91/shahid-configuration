...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "FR", "SHAHID_VIP_SPORT","SA" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'deals[0].specialOfferLandingPage.visualElements[1].value[0]',"<ul> <li>L'abonnement sera automatiquement renouvelé </li> <li> Frais mensuels de SAR 57.99 (TTC) </li> <li> Pour plus d'informations contacter : care@shahid.net </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].groups[0].pricingPlans[0].visualElements[18].value',"<ul> <li>يتم تجديد الاشتراك تلقائياً </li> <li>رسوم الاشتراك الشهري 57.99 SAR (شاملة لضريبة القيمة المضافة) </li> <li>للاستفسارات الرجاء التواصل مع  care@shahid.net </li> </ul>")
...
WS.verifyElementPropertyValue(getResponse, 'deals[3].groups[0].pricingPlans[0].visualElements[18].value',"اشترك واحصل على دوري روشن السعودي  ، الفورمولا 1 ، WWE  و أفضل العروض الترفيهية و المزيد. رسوم الاشتراك الشهري 69.99 SAR")
...
WS.verifyElementPropertyValue(getResponse, 'deals[3].specialOfferLandingPage.visualElements[1].value[0]',"<ul> <li>يتم تجديد الاشتراك تلقائياً </li> <li>رسوم الاشتراك الشهري 57.99 SAR (شاملة لضريبة القيمة المضافة) </li> <li>للاستفسارات الرجاء التواصل مع  care@shahid.net </li> </ul>")
