...
WS.verifyElementPropertyValue(getResponse, 'deals[0].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 34,99  par mois (TTC)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[1].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 34,99  par mois (TTC)")
...
WS.verifyElementPropertyValue(getResponse, 'deals[2].groups[0].pricingPlans[0].visualElements[18].value',"Shahid VIP - Le meilleur du divertissement au même endroit. Abonnez-vous dès maintenant pour SAR 34,99  par mois (TTC)")
