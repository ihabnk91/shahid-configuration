...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "EN", "SHAHID_VIP","OM" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_30P_OMN')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_40P_OMN')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].currency', 'OMR')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].value', 'OMR')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].productId', "OMN_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'OMR')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_30P_OMN')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].currency', 'OMR')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[9].value', 'OMR')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].productId', "OMN_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'OMR')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_40P_OMN')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].currency', 'OMR')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[9].value', 'OMR')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].productId', "OMN_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'OMR')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_50P_OMN')
