...
def getResponse = CustomKeywords.'config_files.getConfigFile.getConfig'("WEB", "EN", "SHAHID_VIP","IQ" , "false")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].price', '3500.0')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[8].value', '3500')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '3500')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[0].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_30P_IRQ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].price', '3000.0')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[8].value', '3000')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '3000')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[1].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_40P_IRQ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].price', '2500.0')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[8].value', '2500')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '2500')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[2].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'RE_50P_IRQ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].price', '3500.0')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[8].value', '3500')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '3500')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_30P_IRQ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].price', '3000.0')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[8].value', '3000')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '3000')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_40P_IRQ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].price', '2500.0')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].currency', 'IQD')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[8].value', '2500')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[9].value', 'IQD')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].productId', "IRQ_B2C_SHAHID_VIP_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '2500')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'IQD')
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_50P_IRQ')
