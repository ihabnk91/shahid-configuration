...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[1].value','احصل على خصم 30%' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[13].value', 'وفر 30%')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[1].value','احصل على خصم 40%' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[13].value', 'وفر 40%')
...
WS.verifyElementPropertyValue(getResponse, 'offers[11].groups[0].pricingPlans[0].visualElements[1].value','احصل على خصم 50%' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[11].groups[0].pricingPlans[0].visualElements[13].value', 'وفر 50%')
