...
WS.verifyElementPropertyValue(getResponse, 'offers[6].offerId', "winback-sport-30-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[6].offerParam', "sportsoffer30")
...
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].price', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].currency', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].visualElements[1].value','30% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].visualElements[8].value', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 30% ')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[6].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'WB_SPORT_30P_EGY')
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].offerId', "winback-sport-40-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[7].offerParam', "sportsoffer40")
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].price', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].currency', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].visualElements[1].value','40% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].visualElements[8].value', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 40% ')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[7].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'WB_SPORT_40P_EGY')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].offerId', "winback-sport-50-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[8].offerParam', "sportsoffer50")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].price', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].currency', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].order','0')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].packageId',"SHAHID_VIP_SPORT")
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].catalogId',"SPORT")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[1].value','50% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[8].value', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 50% ')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[8].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'WB_SPORT_50P_EGY')
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].offerId', "byg-sport-30-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[12].offerParam', "bygsportsoffer30")
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].price', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].currency', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].visualElements[1].value','30% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].visualElements[8].value', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 30% ')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '76.99')
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[12].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_SPORT_30P_EGY')
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].offerId', "byg-sport-40-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[13].offerParam', "bygsportsoffer40")
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].price', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].currency', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].visualElements[1].value','40% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].visualElements[8].value', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 40% ')
...
// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
...
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '65.99')
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[13].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_SPORT_40P_EGY')
...
WS.verifyElementPropertyValue(getResponse, 'offers[14].offerId', "byg-sport-50-offer")
WS.verifyElementPropertyValue(getResponse, 'offers[14].offerParam', "bygsportsoffer50")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].period', 'monthly')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].featured', "true")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].price', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].currency', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].order','0')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].packageId',"SHAHID_VIP_SPORT")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].catalogId',"SPORT")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[0].key', 'Header_1_text')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[0].value', 'Abonnez-vous dès maintenant et profitez de vos programmes sans publicité')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[1].key', 'display_title')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[1].value','50% de réduction' )
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[3].key', 'deduction_text')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[3].value', 'facturation mensuelle')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[6].key', 'show_payment_logo')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[6].value', 'true')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[8].key', 'price')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[8].value', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[9].key', 'currency')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[9].value', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[10].key', 'duration')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[10].value', 'Mensuel')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[11].key', 'featured_tag_text')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[11].value', 'Offre limitée')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[13].key', 'tag_text')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 50% ')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[12].key', 'show_tag')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].visualElements[12].value', 'true')

// CC Only NSF Offer
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].productId', "EGY_B2C_SHAHID_VIP_SPORT_1M")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].paymentMethod', 'CREDIT_CARD')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].freeTrialEnabled', "false")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].showIn[0]', "VERTICAL_MODE")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].showIn[1]', "HORIZONTAL_MODE")
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].priceLabel', '54.99')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].currencyLabel', 'EGP')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].dealId', 'BYG_SPORT_50P_EGY')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].allowedForAcquisition', 'true')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[0].key','title')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[0].value','Carte de crédit/débit')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[1].key','CTA_text')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[1].value','S’abonner')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[2].key','logo')
WS.verifyElementPropertyValue(getResponse, 'offers[14].groups[0].pricingPlans[0].pricingPlanData[0].visualElements[2].value','https://static.s3.shahid.mbc.net/widget-images/icons/iconCreditCard.png')
