...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[1].value','30% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[9].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 30% ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[1].value','40% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[10].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 40% ')
...
WS.verifyElementPropertyValue(getResponse, 'offers[11].groups[0].pricingPlans[0].visualElements[1].value','50% de réduction' )
...
WS.verifyElementPropertyValue(getResponse, 'offers[11].groups[0].pricingPlans[0].visualElements[13].value', 'Économisez 50% ')
